...
class StickerPackViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        addButton.setTitle("Add Beans to WhatsApp", for: .normal)
        ...
        shareButton.setTitle("Share it :)", for: .normal)
        ...
        tapGuideLabel.text = "Tap on any Capsubeans to copy or share it"
    ...
    func showActionSheet(withSticker sticker: Sticker) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Share it Now", style: .default, handler: { action in
